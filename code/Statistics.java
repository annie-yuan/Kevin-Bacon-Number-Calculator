...
//This class is a helper class for calculating statistics  based on a list of integer values. 
...
public class Statistics {
	...
	//Constructs a new Statistics object based on a list of integers. 
	//This class doesn't store the integers, but instead calculates the min, max, Q1-Q3, 
	//and counts the number of occurrences of each value.
	...
	//This method calculates the min, max, mean from a list of integers, and also
	//counts the frequency (number of occurrences) of each repeated value in the list.
    ...
    // Returns a list of ordered unique values based on the original list with duplicates.
